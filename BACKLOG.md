...
**Последнее ревью:** 2026-05-23 (поздний вечер) — МАЙН research + аудит ядра; **импульс paper-движок СОБРАН, влит в main, на форварде** (один branch main); памп день 1 = красный флаг (−11.5%)
