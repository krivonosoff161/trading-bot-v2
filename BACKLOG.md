...
**Последнее ревью:** 2026-05-23 (вечер) — МАЙН research проведён целиком + аудит ядра; памп paper ЗАПУЩЕН и день 1 = красный флаг (см. ниже)
...
**▶ СЛЕДУЮЩЕЕ:** (1) фикс B1 (быстро); (2) собрать ИМПУЛЬС как paper-движок (единственное доказанное) →
форвард; (3) переделать снапшот+LLM-шаблон под `exit_rule` (ride, не фикс TP2); (4) фейд/grind — research, без иллюзий.
