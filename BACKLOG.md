...
**Последнее ревью:** 2026-05-26 — тайминг входа исследован: относит. улучшение робастно, абсолют НЕ робастен (архив-OOS убил майский DRIFT +1%); решение — чинить момент САМОГО сигнала, задача ушла GPT
