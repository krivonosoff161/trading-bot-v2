...
**Последнее ревью:** 2026-05-28 — ЛЕЙБЛЕР-МЕТОДОЛОГИЧЕСКАЯ ДЫРА (limit→market) ПОЙМАНА; перелейбл архива: WR 55%→**76%**, sumR −10.49→**+8.81**, direction-эдж Main WS РЕАЛЕН (2+ нед хоронили на фантоме). Cycle-1 пакет (`533e69d`) запущен 14:22 UTC, 10-дневный цикл наблюдения до ~07.06. Канон `docs/cycle_1_launch_2026-05-28.md`.
