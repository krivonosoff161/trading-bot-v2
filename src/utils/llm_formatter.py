...
- ТРЕНДОВЫЙ: движение сильное и направленное. "Импульс низкий" или "перепродан" — это НЕ сигнал разворота, это подтверждение тренда вниз. Писать: "сильный тренд [вниз/вверх], входим по направлению", "давление [продавцов/покупателей] сохраняется".
