...
| `scripts/run_latest_analysis.py` | Interactive launcher; lazy-imports `auto_execute.execute_signal` (130-135) | reaches the .env-gated money path | Non-interactive driver routing ENTRY → **paper** executor |
