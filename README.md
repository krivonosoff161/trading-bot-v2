...
| 📊 Проверено (research) | Pump reversal закрыт (комиссия > edge); continuation MFE подтверждён, захват движения в работе |
| ✅ Готово | Система записи данных (тики / снапшоты / фичи) под будущее обучение |
| 🔬 Research | Pump continuation — структурный выход по слому + кластер-режим |
| 🔬 Research | Ранний вход в импульс + динамический стоп за структуру |
