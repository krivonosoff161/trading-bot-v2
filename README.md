...
| **Pump Reversal** | Вход **против** направления взрывной 1m свечи на отобранных альтах | 1m explosion | paper, фаза накопления сделок |
...
| Статус | Направление |
|--------|-------------|
| ✅ Подтверждено (research/paper) | Main WS-скринер с режимными сигналами и контекст-гейтом |
| ✅ Подтверждено (research) | Реверсальный эдж на отдельных альтах (выведен из tape-данных) |
| ✅ Готово | Система записи данных (тики / снапшоты / фичи) под будущее обучение |
| 🔧 В тесте | Pump Reversal — paper-движок, накопление сделок до валидации WR/PF |
| 🔧 В тесте | Intra-candle ранний вход + динамический перенос стопа |
